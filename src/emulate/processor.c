...
u_int64_t read_register(bool in64BitMode, u_int32_t registerNumb){
...
void write_register(bool in64BitMode, u_int32_t registerNumb, u_int64_t data){
...
uint64_t read_memory(bool in64BitMode, u_int64_t memoryAddress){
...
bool write_memory(bool in64BitMode, u_int64_t memoryAddress, u_int64_t data) {
    assert((0 <= memoryAddress) && (memoryAddress < MEMORYSIZE));
